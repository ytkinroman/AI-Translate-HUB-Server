...
# Настройки API ключей для сервисов перевода
...
# Настройки WebSocket
WS_PING_INTERVAL = 20  # Интервал пинга WebSocket соединения в секундах
WS_PING_TIMEOUT = 20   # Таймаут ожидания ответа на пинг в секундах
...
# Настройки API сервисов перевода
